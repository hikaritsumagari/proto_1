...
$sql = 'INSERT INTO item_table(item_id, user_id, item_img, exif_date, exif_year, title, description, is_deleted, created_at, updated_at) VALUES(NULL, :user_id, :item_img, :exif_date, :exif_year, :title, :description, 0, sysdate(), sysdate())';
