...
// ---------*ランダム*----------
$sql = 'SELECT item_img FROM item_table WHERE user_id=? AND is_deleted=0 ORDER BY RAND() LIMIT 1';
...
foreach ($rand as $item) {
    // var_dump($rand);
    // exit;
    $rand_image .= '<img src="' . $item["item_img"] . '" class="rand_img">';
}
...
<body>
    ...
    <footer>
        <div class="nav_bottom">
            <a href="view.php" class="btn"><i class="fas fa-home fa-2x"></i></a>
            <a href="file_upform.php" class="btn"><i class="fas fa-plus-square fa-2x"></i></a>
            <a href="child.php" class="btn"><i class="fas fa-user-alt fa-2x"></i></a>
        </div>
    </footer>
